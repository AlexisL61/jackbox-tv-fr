    ...
    ["games/pushthebutton"], {
        56716: (e, t, s) => {
            ...
            const v = m().View.extend({
                ...
                startInterval() {
                    this.intervalCount = 0, this.model.set("message", "RESTEZ APPUYÉ POUR ACCUSER"), this.model.set("shake", "none"), this.interval = setInterval(this.onInterval.bind(this), 1e3)
                },
                onInterval() {
